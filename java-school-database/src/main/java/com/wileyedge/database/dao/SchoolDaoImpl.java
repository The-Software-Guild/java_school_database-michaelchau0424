...
public class SchoolDaoImpl implements SchoolDao {
    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT c.courseCode, c.courseDesc, COUNT(*) AS numStudents FROM course c INNER JOIN course_student cs ON c.cid = cs.course_id INNER JOIN student s ON cs.student_id = s.sid GROUP BY c.courseCode, c.courseDesc";
    ...
    public void editCourseDescription() {
        ...
        String sql = "UPDATE TABLE course SET courseDesc = 'Advanced Python with Flask' WHERE courseCode = 'CS305'";
